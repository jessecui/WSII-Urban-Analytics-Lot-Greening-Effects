...
write.csv(results_df,"../analysis_results/model_coefs.csv")
...
jpeg(file="../analysis_imgs/rocs.jpg", width=600, height=600)
...
write.csv(all_metrics, "../analysis_results/all_metrics.csv")
# -------- PROPENSITY SCORING -----------------
