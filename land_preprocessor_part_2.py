...
Finds the areas of land use plot types for each greened lot
"""
...
print("STEP 1: Assigning land areas to greened lots")
...
for zone_index in range(df_geometry_list.zone.count()):
    ...
    for lot_index, lot_row in greened_lots_df_core.iterrows():
        ...
        try:
            ...
            zone_areas.append(-1)
    file_string = "data/processed_data/Land_Use/Lot_Proportions/greened_areas_"+zone_name[:3]+str(zone_index)+".pickle"
